...
public class Inventario extends javax.swing.JPanel {
    ...
    private void btn_regis1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_regis1MouseClicked
        int i = metodos.guardar_inv(txt_nom_inv.getText(), txt_pre_com_inv.getText(), txt_pre_ven_inv.getText(), txt_cant_inv.getText(), txt_cant_inv.getText(),txt_url_inv.getText(),txt_descr_inv.getText());
        if (i > 0) {
